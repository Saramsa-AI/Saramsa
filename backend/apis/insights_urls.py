...
urlpatterns = [
    ...
    path('analyses/<str:analysis_id>/retrigger/', RetriggerAnalysisView.as_view(), name='insights_analysis_retrigger'),
    ...
    path('ingest/', FeedbackFileIngestView.as_view(), name='insights_ingest'),
    ...
    path('user-stories/<str:user_story_id>/', UserStoryUpdateView.as_view(), name='insights_user_story_update'),
