  ...
  useEffect(() => {
    ...
    if (latestAnalysis?.analysis?.userStories?.work_items) {
      ...
      const userStoriesData = [{
        ...
        process_template: latestAnalysis.analysis.userStories.process_template || getProviderProcessTemplate(latestAnalysis.analysis.userStories.platform || selectedPlatform || 'azure'),
